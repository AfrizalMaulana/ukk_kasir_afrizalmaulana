...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 29, 2024 at 02:21 AM
...
(2147483647, 'mahfod', 'hjgsfdfghr45refr', '0852544573'),
(2802081529, 'dasdas', 'alamat', '23123123');
...
(1, '2024-02-28', 99999999.99, 2147483647),
(2, '2024-02-28', 154.00, 2802081529);
...
(1, 'rizal', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1),
(2, 'mahfod', 'petugas', 'afb91ef692fd08c445e8cb1bab2ccf9c', 2);
...
--
ALTER TABLE `pelanggan`
  MODIFY `pelanggan_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2802081530;
